...
#define CLIENT_ID        "house"                                 //设备名称


#define MQTT_CMDTOPIC_SUB    "fsembsim/fs_embsim/greenhouse/sub"
#define MQTT_DATATOPIC_PUB   "fsembsim/fs_embsim/greenhouse/pub"                 // 属性上报topic
