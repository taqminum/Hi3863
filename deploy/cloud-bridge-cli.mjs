export function parseBridgeArgs(argv, env = process.env) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    ...
    if (part === "--device-id") options.deviceId = next;
...
export function validateBridgeOptions(options) {
